...
# Example sentence
sentence = "Some say the witness is not truly honest, just persuasive."
...
cruel_token = [token for token in doc if token.text.lower() == "honest"][0]
print(f"'honest' token dep_: {cruel_token.dep_}, head: {cruel_token.head.text}, pos: {cruel_token.pos_}")
